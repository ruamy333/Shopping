...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="banner" class="container"> 
		...
		<div id="three-column" class="container">
			...
			<div class="columnbox">
				<a href="View/Product.aspx?t=光纖量測產品" class="image image-full"><img src="Picture/img01.jpg" alt=""/></a>
				<h2>光纖量測產品</h2>
				<p>● 光時域反射儀 (OTDR)<br/>● 穩定雷射光源及光功率計<br/>● 可視故障定位器</p>
				<a href="View/Product.aspx?t=光纖量測產品" class="button-style">More</a>
			</div>
			<div class="columnbox">
                <a href="View/Product.aspx?t=光纜監測管理系統" class="image image-full"><img src="Picture/img02.jpg" alt=""/></a>
				<h2>光纜監測管理系統</h2>
			...
			<div class="columnbox">
                <a href="View/Product.aspx?t=光電轉換產品" class="image image-full"><img src="Picture/img03.jpg" alt=""/></a>
				<h2>光電轉換產品</h2>
